...
const int irMax1 = 560;
const int irMin1 = 10;

const int irMax2 = 560;
const int irMin2 = 10;

const int THRESHOLD1 = 30;      // threshold for solinod valves
const int THRESHOLD2 = 10;       // threshold for midicc stepping
const int THRESHOLD3 = 20;      // threshold fpr midi not on
